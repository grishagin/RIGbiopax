add_db_ids <-
  function(owl_biopax=NULL
    ...
    #' @export
    #' @title
    #' Get DB-ID Pairs for Pathway
    #' @description 
    #' For a given pathway id, extract all db-id pairs from a BioPAX object.
    #' @details 
    #' Returns a dataframe.
    #' @param owl_biopax BioPAX object.
    #' @param pw_id Pathway id.
    #' @param biopaxlevel (optional) BioPAX level.
