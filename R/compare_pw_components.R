compare_pw_components<-
  function(biopax_prot=NULL
    ...
    #' @export
    #' @title
    #' Compare BioPAX Pathway Components between Source and ToxDB
    #' @description 
    #' Compares two dataframes from a source BioPAX and its ToxDB counterpart
    #' that contain components of interest for a given pathway. 
    #' Refer to the parent function.
    #' @param biopax_prot Dataframe with components of interest from source.
    #' @param biopax_prot Dataframe with components of interest from ToxDB.
    #' @param dfrow Dataframe that contains pathway metadata (Name, ID, etc.).
    #' @param output Types of matches to return.
